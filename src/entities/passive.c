...
void randomMovement(Passive* passive) {
    ...
    switch (direction) {
        case 1:
            moveEntity(passive->attributes.position.y + 1, passive->attributes.position.x, &passive->attributes.position, passive->attributes.symbol);
            break;
        ...
        case 3:
            moveEntity(passive->attributes.position.y, passive->attributes.position.x + 1, &passive->attributes.position, passive->attributes.symbol);
            break;
